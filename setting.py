...
class Setting:
	...
	def score_label(self, name_1, name_2):
		player_o = general_font.render(f'{name_1}: {self.player_o_score}', True, BLACK)
		player_x = general_font.render(f'{name_2}: {self.player_x_score}', True, BLACK)
		tie = general_font.render(f'Tie: {self.tie}', True, BLACK)

		self.screen.blit(player_o, (10, 10))
		self.screen.blit(player_x, (10, 40))
		self.screen.blit(tie, (10, 70))
